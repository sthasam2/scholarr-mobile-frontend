...
@JsonSerializable()
class PlagiarismListItem {
  Map submission_agent;
  Map submission_target;
  double percentage_plagiarized;

  PlagiarismListItem({
    required this.submission_agent,
    required this.submission_target,
    required this.percentage_plagiarized,
  });

  factory PlagiarismListItem.fromJson(Map<String, dynamic> json) =>
      _$PlagiarismListItemFromJson(json);

  Map<String, dynamic> toJson() => _$PlagiarismListItemToJson(this);
}
