...
PlagiarismListItem _$PlagiarismListItemFromJson(Map<String, dynamic> json) =>
    PlagiarismListItem(
      submission_agent: json['submission_agent'] as Map<String, dynamic>,
      submission_target: json['submission_target'] as Map<String, dynamic>,
      percentage_plagiarized:
          (json['percentage_plagiarized'] as num).toDouble(),
    );

Map<String, dynamic> _$PlagiarismListItemToJson(PlagiarismListItem instance) =>
    <String, dynamic>{
      'submission_agent': instance.submission_agent,
      'submission_target': instance.submission_target,
      'percentage_plagiarized': instance.percentage_plagiarized,
    };
