...
class ClassContentItemScreen extends StatefulWidget {
  final ClasscontentManager classcontentManager;

  const ClassContentItemScreen({
    Key? key,
  ...
  static MaterialPage page({
    ...
    return MaterialPage(
      name: AppPages.classroomContentItemPath,
      key: ValueKey(AppPages.classroomContentItemPath),
      child: ClassContentItemScreen(
  ...
  @override
  State<ClassContentItemScreen> createState() => _ClassContentItemScreen();
}

class _ClassContentItemScreen extends State<ClassContentItemScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              widget.classcontentManager.cancelCreateNewItem();
      ...
      return SizedBox(
        ...
        child: MaterialButton(
          ...
          onPressed: () async {
            ...
            _response = await _classcontentClient.createClasscontent(
              widget.classcontentManager.selectedClassroomIndex,
              _title,
              _description,
              _dropdownValue,
              _selectedDateString,
              int.parse(_weightage!),
              _pickedFilePath!,
              widget.classcontentManager.getCreateClasscontentType!,
            );
